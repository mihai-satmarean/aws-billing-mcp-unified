...
from awslabs.billing_cost_management_mcp_server.tools.skylite_tools import register_skylite_tools
...
async def setup():
    ...
    # Skylite custom tools (get_cost_by_tag, get_monthly_costs, credits, invoices, etc.)
    register_skylite_tools(mcp)
